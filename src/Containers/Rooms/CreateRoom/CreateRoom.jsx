...
const TabsInfo = [
    {
        id: 0,
        name: 'Россия',
        img: <img src='/assets/images/TournirTabs/Group 263 (1).png' alt='Россия'/>
    },
    {
        id: 1,
        name: 'Италия',
    ...
    },
    {
        id: 4,
        name: 'Испания',
        img: <img src='/assets/images/TournirTabs/Group 265 (1).png' alt='Испания'/>
    },
    {
        id: 5,
        name: 'Германия',
    ...
    },
    {
        id: 6,
        name: 'Все страны',
        img: <img src='/assets/images/TournirTabs/Group 265.png' alt='Все страны'/>
    }
];
                ...
                <Tabs defaultActiveKey="1" >
                    <Tabs.TabPane tab="Футбол" key="1">
                        <div className={s.all__countries}>
                            <label htmlFor="all" className={s.select__all}>Выбрать все страны</label>
                        ...
                        <Button hoverable shape='round' style={{margin: '20px auto', display: 'block'}}>
